# Spec: ocupacion-web-selector-persona-buscador

> Change: `2026-07-29-web-ocupaciones-buscador-personas-issue-216` (issue #216). Capacidad NUEVA derivada de la reutilización del modal `_PersonaBuscadorModal.cshtml` + `usuario-persona-buscador.js` en el formulario Create/Edit de Ocupaciones. Idioma: español neutro. Código/identificadores: inglés.
