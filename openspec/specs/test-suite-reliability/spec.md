# Confiabilidad de la suite de pruebas

## Propósito

Este spec define los contratos técnicos verificables que la suite `tests/SGV.Tests` debe satisfacer para ser determinista, repetible y libre de contención entre hosts de integración. No describe comportamiento de producto; describe invariantes operacionales de la infraestructura de pruebas.
