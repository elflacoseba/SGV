...
public sealed class CrearCargoRequestValidatorTests
{
    private static readonly Guid NivelIdValido = Guid.Parse("70000000-0000-0000-0000-000000000001");

    private static CrearCargoRequest RequestValido() => new(
        Codigo: "DIR-01",
        Nombre: "Director General",
        NivelId: NivelIdValido);

    private readonly CrearCargoRequestValidator _validator = new();
    ...
    {
        var request = RequestValido() with { Codigo = "DIR-01" };
